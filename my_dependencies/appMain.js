    ...
    _GetEventInfoXHR = (event_id) => {
        ...
        request.onload = () => {
            ...
            parsed_response = {
                exit_code: 1,
                data: {
                    'email': 'alsdnthd1234@kaist.ac.kr',
                    'username': 'thatUser',
                    'category': 'taxi',
                    ...
                    'num_member': 4,
                    'cur_member': 2,
                    'members': [['testemail@kaist.ac.kr', 'minwoo'], ['anotherppl@kaist.ac.kr', 'thatGuy']],
                }
            }
            //
    ...
    render() {
        return (
            <View style={this.state.page}>
                ...
                <EventPage page = {this.state.page} email = {this.state.email} password = {this.state.password} mainPageFunc = {this.MoveToMainPage} event_data = {this.state.event_data} refreshFunc = {this.MoveToEventPage}/>
